...
//        list2.insert2(5);
        ...
        Map<String, Object> linkedMap = new LinkedHashMap<>(10, 0.75f, true);
        linkedMap.put("2", 51);
        linkedMap.put("1", 51);
        linkedMap.put("5", 51);
        linkedMap.put("3", 51);
       ...
       linkedMap.forEach((k,v)-> System.out.println(k));
        ...
        Map<String, Object> linkedMap2 = new LinkedHashMap<>(10, 0.75f);
        ...
        linkedMap2.put("1", 51);
        linkedMap2.get("2");
        linkedMap2.forEach((k,v)-> System.out.println(k));
